...
angulo = np.rad2deg(np.arctan2(vy, vx))

print(f'Maior raio = {maior_raio}\n')
print(f'Menor raio = {menor_raio}\n')
print(f'Ângulo = {angulo}\n')

# Desenha elipse equivalente
...
np.sort(raios)
cv2.ellipse(I3, np.int32(c0), np.int32(raios), angulo, 0, 360, color, thickness)
plt.figure()
